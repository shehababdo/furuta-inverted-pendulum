...
#ifndef typedef_Encoder_arduino_HIL_T
#define typedef_Encoder_arduino_HIL_T

typedef struct tag_tNlF2jjOTTyeKhyBNhAbs Encoder_arduino_HIL_T;

#endif                                 /* typedef_Encoder_arduino_HIL_T */
